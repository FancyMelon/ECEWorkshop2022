  ...
  return (
    <div className="themes-container container">
      ...
      <div className="themes-intro mx-auto my-2 col-md-8 col-12">
        <p>
          The workshops aim at first-year students who had difficulties with
          APS105 contents and wished to explore more on the software side in the
          ECE program. The workshops build on several software programming
          skills to assist the students through either projects or activities.
        </p>
      </div>
