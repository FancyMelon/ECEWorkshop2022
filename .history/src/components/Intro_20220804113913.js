    ...
    <div className="intro-container container">
      ...
      <div className="description mr-auto px-3">
        ...
        <p className="description-text">
          ...
          <br />
          <br />
          This event is open to all undergraduate and master students regardless
          of their technical background, hoping to gain some incredible
          prototype-developing experience through this event. It is recommended
          that the participants have an interest in computer programming or a
          preliminary understanding of software development.
        </p>
      </div>
    </div>
  );
