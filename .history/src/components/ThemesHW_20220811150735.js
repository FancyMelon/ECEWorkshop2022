        ...
        <div className="theme-2 theme-item">
          ...
          <div className="theme-title-container">
            ...
            <p>
              ...
              and solve each task on their own. The goals is to have each
              students leaving the workshop knowing they are capable to creating
              their own machine learning program with little assistance from the
              staff and others.
            </p>
          </div>
        </div>
