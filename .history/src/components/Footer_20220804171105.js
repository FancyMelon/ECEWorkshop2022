...
import igAccount from "../assets/images/igAccount.JPG";
    ...
    <div className="footer-container container">
      <div className="utada-container col-12 col-md-6">
        ...
        <code className="utada-text">
          University of Toronto <br /> Application Development Association
        </code>
      </div>
      <div className="footer-contents col-12 col-md-6 m-auto">
        <div className="contacts">
          <div className="contact email">
            <a
              href="mailto:helenjy.liang@mail.utoronto.ca"
              target="_blank"
              rel="noreferrer"
            >
              <img src={emailIcon} alt="helenjy.liang@mail.utoronto.ca" />
            </a>
          </div>
          <div
          ...
          >
            <img src={igIcon} alt="UT助手" />
          </div>
        </div>
      </div>

      <div className="copyright">
        Copyright © 2021 University of Toronto Application Development
        Association. All rights reserved.
      </div>

      <div
        className="modal modal-dialog-centered fade qr-code-modal"
        id="qrCodeModal"
